...
module.exports = {
  name: "team",
  description: "Edit whether other users can operate your own book",
  name_localizations: {
    "zh-TW": "團隊",
  },
  ...
  options: [
    {
      name: "add",
      description: "Add other users to operate your own book",
      name_localizations: {
        "zh-TW": "添加",
      },
      description_localizations: {
    ...
    {
      name: "remove",
      description: "Delete a user that has been added to a team",
      name_localizations: {
        "zh-TW": "刪除",
      },
      description_localizations: {
  ...
  run: async (client, interaction, args, tr) => {
    ...
    const cmd = interaction.options._subcommand;
    if (cmd == "add") {
